...
NS_GI_BEGIN
    ...
    public:
        ...
        virtual void
        setFramebuffer(Framebuffer *fb, RotationMode outputRotation = RotationMode::NoRotation);
        ...
        captureAProcessedFrameData(Filter *upToFilter, int width = 0, int height = 0);
