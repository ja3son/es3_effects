...
NS_GI_BEGIN
    ...
    CannyEdgeDetectionFilter::CannyEdgeDetectionFilter()
            : _grayscaleFilter(0), _blurFilter(0), _edgeDetectionFilter(0),
              _nonMaximumSuppressionFilter(0), _weakPixelInclusionFilter(0) {
    }
    ...
    bool CannyEdgeDetectionFilter::init() {
        ...
        _grayscaleFilter->addTarget(_blurFilter)->addTarget(_edgeDetectionFilter)->addTarget(
                _nonMaximumSuppressionFilter)->addTarget(_weakPixelInclusionFilter);
