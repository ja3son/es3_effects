...
NS_GI_BEGIN
    ...
    SingleComponentGaussianBlurFilter::create(int radius/* = 4*/, float sigma/* = 2.0*/) {
        SingleComponentGaussianBlurFilter *ret = new(
                std::nothrow) SingleComponentGaussianBlurFilter();
