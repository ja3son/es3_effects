...
NS_GI_BEGIN
    ...
    Source::Source()
            : _framebuffer(0), _outputRotation(RotationMode::NoRotation), _framebufferScale(1.0) {
...
//        }
    ...
    unsigned char *
    Source::captureAProcessedFrameData(Filter *upToFilter, int width/* = 0*/, int height/* = 0*/) {
