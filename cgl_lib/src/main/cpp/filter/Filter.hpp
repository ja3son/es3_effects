...
// Hardcode the vertex shader for standard filters, but this can be overridden
    ...
    public:
        ...
        static Filter *createWithShaderString(const std::string &vertexShaderSource,
        ...
        virtual bool
        initWithFragmentShaderString(const std::string &fragmentShaderSource, int inputNumber = 1);

        void setFilterClassName(
                const std::string filterClassName) { _filterClassName = filterClassName; }
        ...
        bool
        registerProperty(const std::string &name, int defaultValue, const std::string &comment = "",
